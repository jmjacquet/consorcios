...
AUTHENTICATION_BACKENDS = ('django.contrib.auth.backends.ModelBackend','boletas.authentication.UbicacionBackend','boletas.authentication.ContribuyentesBackend')
